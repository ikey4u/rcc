...
sh -n scripts/build-macos-x64-release.sh
...
sh -n scripts/build-linux-aarch64-release.sh
sh -n scripts/build-windows-x64-release.sh
sh -n scripts/build-windows-arm64-release.sh
sh -n scripts/stage-darwin-compiler-rt.sh
sh -n scripts/stage-apple-sdk.sh
sh -n scripts/setup-env.sh
sh -n scripts/verify-macos.sh
sh -n scripts/verify-sqlite.sh
python3 -m json.tool toolchains/sqlite-amalgamation-3500400.lock.json >/dev/null
...
python3 -m json.tool toolchains/llvm-22.1.8-linux-arm64.lock.json >/dev/null
python3 -m json.tool toolchains/llvm-22.1.8-windows-x64.lock.json >/dev/null
python3 -m json.tool toolchains/llvm-22.1.8-windows-arm64.lock.json >/dev/null
